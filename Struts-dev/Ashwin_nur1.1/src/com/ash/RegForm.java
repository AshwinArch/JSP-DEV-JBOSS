...
*
* <Short Description formbean class for rigistration>
*
* <Version Number > 
*
 ...
 * 
 * @see 	private String t1;
 * @see 	private int pincode;
 * @see 	private String firstname;
 * @see 		private String lastname;
 * @see 		private String username; 
 * @see private String password; 
* @see	private String email; 
* @see	private String address; 
* @see	private String city; 
* @see	private String state; 
* @see	private int coun_id; 
* @see	private String interest; 
* @see	private long contact; 
* @see	private String subs;
 */
	private String t1;
			...
			HttpServletRequest request) 
	{
		...
		else if(pincode<=99999 || pincode>=9999999999l)
		{
		...
		else if(contact>=999999999999999l ||contact<=99999999 )
		{
